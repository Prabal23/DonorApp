...
class AppShareAndroid extends StatefulWidget {
  final androidLink;
  AppShareAndroid(this.androidLink);

  @override
  State<StatefulWidget> createState() => AppShareAndroidState();
}

class AppShareAndroidState extends State<AppShareAndroid> {
  ...
  @override
  void initState() {
    _dataString = widget.androidLink == null? '---' : widget.androidLink;
    super.initState();
  }
