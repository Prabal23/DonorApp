...
import 'RiderNotificationDetails.dart';

class RiderNotificationPage extends StatefulWidget {
  @override
  _RiderNotificationPageState createState() => _RiderNotificationPageState();
}
                                        ...
                                        onTap: () {
                                          ...
                                          if (notificData[index].title != null) {
                                            Navigator.push(
                                                context,
                                                SlideLeftRoute(
                                                    page: RiderNotificationDetails(notificData[index].title,
