...
import 'incident_add_image_screen.dart';

class IncidentAddScreen extends StatefulWidget {
  @override
  _IncidentAddScreenState createState() => _IncidentAddScreenState();
}

class _IncidentAddScreenState extends State<IncidentAddScreen> {
  String _value;
  double lat;
  double lan;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                padding: EdgeInsets.fromLTRB(2, 10, 10, 8),
                child: TextField(
                ...
                child: RaisedButton(
                  onPressed: () {
                    if (categoryId == null || categoryId == '') {
                      ...
                      _showMessage("Donor Message field is empty");
