...
import 'PublicReporterNotificationDetails.dart';

class PublicReporterNotificationPage extends StatefulWidget {
  @override
  _PublicReporterNotificationPageState createState() => _PublicReporterNotificationPageState();
}

class _PublicReporterNotificationPageState extends State<PublicReporterNotificationPage> {
                                        ...
                                        onTap: () {
                                          ...
                                          if (notificData[index].title != null) {
                                            Navigator.push(
                                                context,
                                                SlideLeftRoute(
                                                    page: PublicReporterNotificationDetails(notificData[index].title,
  ...
  Future<bool> _onWillPop() async {
    Navigator.push(context,
                      SlideLeftRoute(page: PublicReporter()));
    return false;
    // WillPopScope(
  //       onWillPop: _onWillPop,
  }
